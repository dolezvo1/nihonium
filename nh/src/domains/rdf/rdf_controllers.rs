...
inventory::submit! {DiagramInfo {
    ...
    diagram_creation_data: DiagramCreationData {
        ...
        constructors: &[
            ("empty", &((|no| format!("New RDF diagram {}", no)) as DefaultNameF), &(new as DiagramConstructorF)),
            ("demo", &((|no| format!("Demo RDF diagram {}", no)) as DefaultNameF), &(demo as DiagramConstructorF)),
            ("stress test 2k", &((|no| format!("Stress test RDF diagram {}", no)) as DefaultNameF), &(stress_test::<20, 20, 20> as DiagramConstructorF)),
            ("stress test 5k", &((|no| format!("Stress test RDF diagram {}", no)) as DefaultNameF), &(stress_test::<50, 20, 20> as DiagramConstructorF)),
            ("stress test 10k", &((|no| format!("Stress test RDF diagram {}", no)) as DefaultNameF), &(stress_test::<100, 20, 20> as DiagramConstructorF)),
        ],
    },
