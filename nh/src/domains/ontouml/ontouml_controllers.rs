...
use crate::{
    ...
    common::{
        controller::{
            ...
            GlobalDrawingContext, InsensitiveCommand, MGlobalColor, MultiDiagramController,
            ProjectCommand, View,
        },
...
mod buttons {
    ...
    pub const INSTANCE_BUTTONS: LazyLock<Vec<(usize, usize, &'static str, &InstanceButtonF)>> =
